...
/* Automatically generated by parse-opcodes */
  ...
  def VFLSEGH            = Bits("b???100100000?????010?????1011011")
  ...
  def VFLSEGSTH          = Bits("b???1001??????????011?????1011011")
  ...
  def VFSSEGH            = Bits("b???100100000?????010?????1111011")
  ...
  def VFSSEGSTH          = Bits("b???1001??????????011?????1111011")
  ...
  def VFLH               = Bits("b000100100000?????010?????1011011")
  ...
  def VFLSTH             = Bits("b0001001??????????011?????1011011")
  ...
  def VFSH               = Bits("b000100100000?????010?????1111011")
  ...
  def VFSSTH             = Bits("b0001001??????????011?????1111011")
}
...
object Instructions
{
  ...
  def FCVT_H_L           = Bits("b011001000000?????????????1010011")
  def FCVT_H_LU          = Bits("b011011000000?????????????1010011")
  def FCVT_H_W           = Bits("b011101000000?????????????1010011")
  def FCVT_H_WU          = Bits("b011111000000?????????????1010011")
  def FCVT_L_H           = Bits("b010001000000?????????????1010011")
  def FCVT_LU_H          = Bits("b010011000000?????????????1010011")
  def FCVT_W_H           = Bits("b010101000000?????????????1010011")
  def FCVT_WU_H          = Bits("b010111000000?????????????1010011")
  def FCVT_S_H           = Bits("b100001000000?????????????1010011")
  def FCVT_H_S           = Bits("b100100000000?????????????1010011")
  def FCVT_D_H           = Bits("b100011000000?????????????1010011")
  def FCVT_H_D           = Bits("b100100100000?????????????1010011")

  def FMV_X_H            = Bits("b111001000000?????000?????1010011")
  def FMV_H_X            = Bits("b111101000000?????000?????1010011")
}
