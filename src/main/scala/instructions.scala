...
object HwachaElementInstructions {
  ...
  def VPL                = BitPat("b1000000000000010000000000000000?000?????0000????????101100111111")
  def VPS                = BitPat("b1000000000000010000000000000000?000?????0000????????111100111111")
  ...
  def VPOP               = BitPat("b100001????????10000????0000?????0000????0000????????011000111111")
  ...
  def VPCLEAR            = BitPat("b1000010000000010000????0000?????0000????0000????????011000111111")
  def VPSET              = BitPat("b1000011111111110000????0000?????0000????0000????????011000111111")
  def VPXORXOR           = BitPat("b1000010110100110000????0000?????0000????0000????????011000111111")
  def VPXOROR            = BitPat("b1000010111110110000????0000?????0000????0000????????011000111111")
  def VPXORAND           = BitPat("b1000010001010010000????0000?????0000????0000????????011000111111")
  def VPORXOR            = BitPat("b1000010110101010000????0000?????0000????0000????????011000111111")
  def VPOROR             = BitPat("b1000010111111110000????0000?????0000????0000????????011000111111")
  def VPORAND            = BitPat("b1000010001010110000????0000?????0000????0000????????011000111111")
  def VPANDXOR           = BitPat("b1000010101011010000????0000?????0000????0000????????011000111111")
  def VPANDOR            = BitPat("b1000010101011110000????0000?????0000????0000????????011000111111")
  def VPANDAND           = BitPat("b1000010000000110000????0000?????0000????0000????????011000111111")
}
