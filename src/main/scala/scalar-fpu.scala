...
{ 
  ...
  val D = PREC_DOUBLE
                      ...
                      //        swap |  to |
                      //cmd        |from | fma 
  val FX       = Cat(FCMD_X,      X,X,X,X,X,X,X,X,X,X,X,X)
  val FCVT_S_W = Cat(FCMD_CVT_FI, N,Y,N,N,N,X,Y,Y,N,N,N,Y)
  val FCVT_S_WU= Cat(FCMD_CVT_FI, N,Y,N,N,N,X,Y,Y,N,N,N,Y)
  val FCVT_S_L = Cat(FCMD_CVT_FI, N,Y,N,N,N,X,Y,Y,N,N,N,Y)
  val FCVT_S_LU= Cat(FCMD_CVT_FI, N,Y,N,N,N,X,Y,Y,N,N,N,Y)
  val FCVT_D_W = Cat(FCMD_CVT_FI, N,Y,N,N,N,X,N,Y,N,N,N,Y)
  val FCVT_D_WU= Cat(FCMD_CVT_FI, N,Y,N,N,N,X,N,Y,N,N,N,Y)
  val FCVT_D_L = Cat(FCMD_CVT_FI, N,Y,N,N,N,X,N,Y,N,N,N,Y)
  val FCVT_D_LU= Cat(FCMD_CVT_FI, N,Y,N,N,N,X,N,Y,N,N,N,Y)
  val FCLASS_S = Cat(FCMD_MV_XF,  N,N,Y,N,N,X,Y,N,Y,N,N,Y)
  val FCLASS_D = Cat(FCMD_MV_XF,  N,N,Y,N,N,X,N,N,Y,N,N,Y)
  val FCVT_W_S = Cat(FCMD_CVT_IF, N,N,Y,N,N,X,Y,N,Y,N,N,Y)
  val FCVT_WU_S= Cat(FCMD_CVT_IF, N,N,Y,N,N,X,Y,N,Y,N,N,Y)
  val FCVT_L_S = Cat(FCMD_CVT_IF, N,N,Y,N,N,X,Y,N,Y,N,N,Y)
  val FCVT_LU_S= Cat(FCMD_CVT_IF, N,N,Y,N,N,X,Y,N,Y,N,N,Y)
  val FCVT_W_D = Cat(FCMD_CVT_IF, N,N,Y,N,N,X,N,N,Y,N,N,Y)
  val FCVT_WU_D= Cat(FCMD_CVT_IF, N,N,Y,N,N,X,N,N,Y,N,N,Y)
  val FCVT_L_D = Cat(FCMD_CVT_IF, N,N,Y,N,N,X,N,N,Y,N,N,Y)
  val FCVT_LU_D= Cat(FCMD_CVT_IF, N,N,Y,N,N,X,N,N,Y,N,N,Y)
  val FCVT_S_D = Cat(FCMD_CVT_FF, N,Y,Y,N,N,X,Y,N,N,Y,N,Y)
  val FCVT_D_S = Cat(FCMD_CVT_FF, N,Y,Y,N,N,X,N,N,N,Y,N,Y)
  val FEQ_S    = Cat(FCMD_CMP,    N,N,Y,Y,N,N,Y,N,Y,N,N,N)
  val FLT_S    = Cat(FCMD_CMP,    N,N,Y,Y,N,N,Y,N,Y,N,N,N)
  val FLE_S    = Cat(FCMD_CMP,    N,N,Y,Y,N,N,Y,N,Y,N,N,N)
  val FEQ_D    = Cat(FCMD_CMP,    N,N,Y,Y,N,N,N,N,Y,N,N,N)
  val FLT_D    = Cat(FCMD_CMP,    N,N,Y,Y,N,N,N,N,Y,N,N,N)
  val FLE_D    = Cat(FCMD_CMP,    N,N,Y,Y,N,N,N,N,Y,N,N,N)
  val FSGNJ_S  = Cat(FCMD_SGNJ,   N,Y,Y,Y,N,N,Y,N,N,Y,N,N)
  val FSGNJN_S = Cat(FCMD_SGNJ,   N,Y,Y,Y,N,N,Y,N,N,Y,N,N)
  val FSGNJX_S = Cat(FCMD_SGNJ,   N,Y,Y,Y,N,N,Y,N,N,Y,N,N)
  val FSGNJ_D  = Cat(FCMD_SGNJ,   N,Y,Y,Y,N,N,N,N,N,Y,N,N)
  val FSGNJN_D = Cat(FCMD_SGNJ,   N,Y,Y,Y,N,N,N,N,N,Y,N,N)
  val FSGNJX_D = Cat(FCMD_SGNJ,   N,Y,Y,Y,N,N,N,N,N,Y,N,N)
  val FMIN_S   = Cat(FCMD_MINMAX, N,Y,Y,Y,N,N,Y,N,N,Y,N,N)
  ...
  val FSUB_D   = Cat(FCMD_SUB,    N,Y,Y,Y,N,Y,N,N,N,N,Y,Y)
  val FMUL_D   = Cat(FCMD_MUL,    N,Y,Y,Y,N,N,N,N,N,N,Y,Y)
  val FMADD_S  = Cat(FCMD_MADD,   N,Y,Y,Y,Y,N,Y,N,N,N,Y,Y)
  val FMSUB_S  = Cat(FCMD_MSUB,   N,Y,Y,Y,Y,N,Y,N,N,N,Y,Y)
  val FNMADD_S = Cat(FCMD_NMADD,  N,Y,Y,Y,Y,N,Y,N,N,N,Y,Y)
  val FNMSUB_S = Cat(FCMD_NMSUB,  N,Y,Y,Y,Y,N,Y,N,N,N,Y,Y)
  val FMADD_D  = Cat(FCMD_MADD,   N,Y,Y,Y,Y,N,N,N,N,N,Y,Y)
  val FMSUB_D  = Cat(FCMD_MSUB,   N,Y,Y,Y,Y,N,N,N,N,N,Y,Y)
  val FNMADD_D = Cat(FCMD_NMADD,  N,Y,Y,Y,Y,N,N,N,N,N,Y,Y)
