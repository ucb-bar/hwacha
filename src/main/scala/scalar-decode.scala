...
object ScalarDecode extends VFDecodeTable {
  ...
  //              val? | | d  s1 s2 s3 imm   alufn   dw     sel1    sel2    | fp  fn        | mode  cmd       mt    | fn     | fn      | fn      | fn       | fn      | fn       | fn
  //                 | | | |  |  |  |  |     |       |      |       |       | |   |         | |     |         |     | |      | |       | |       | |        | |       | |        | |
    VLSSEGB   ->List(Y,Y,N,RS,RS,R_,R_,IMM_X,FN_ADD, DW_XPR,A1_RS1, A2_ZERO,N,FP_,FX,       Y,MM_S, M_XRD,    MT_B, N,I_X,   N,IM_X,   N,ID_X,   N,FM_X,    N,FD_X,   N,FC_X,    N,FV_X),
    VLSSEGH   ->List(Y,Y,N,RS,RS,R_,R_,IMM_X,FN_ADD, DW_XPR,A1_RS1, A2_ZERO,N,FP_,FX,       Y,MM_S, M_XRD,    MT_H, N,I_X,   N,IM_X,   N,ID_X,   N,FM_X,    N,FD_X,   N,FC_X,    N,FV_X),
    VLSSEGW   ->List(Y,Y,N,RS,RS,R_,R_,IMM_X,FN_ADD, DW_XPR,A1_RS1, A2_ZERO,N,FP_,FX,       Y,MM_S, M_XRD,    MT_W, N,I_X,   N,IM_X,   N,ID_X,   N,FM_X,    N,FD_X,   N,FC_X,    N,FV_X),
    ...
    VLSSEGBU  ->List(Y,Y,N,RS,RS,R_,R_,IMM_X,FN_ADD, DW_XPR,A1_RS1, A2_ZERO,N,FP_,FX,       Y,MM_S, M_XRD,    MT_BU,N,I_X,   N,IM_X,   N,ID_X,   N,FM_X,    N,FD_X,   N,FC_X,    N,FV_X),
    VLSSEGHU  ->List(Y,Y,N,RS,RS,R_,R_,IMM_X,FN_ADD, DW_XPR,A1_RS1, A2_ZERO,N,FP_,FX,       Y,MM_S, M_XRD,    MT_HU,N,I_X,   N,IM_X,   N,ID_X,   N,FM_X,    N,FD_X,   N,FC_X,    N,FV_X),
    VLSSEGWU  ->List(Y,Y,N,RS,RS,R_,R_,IMM_X,FN_ADD, DW_XPR,A1_RS1, A2_ZERO,N,FP_,FX,       Y,MM_S, M_XRD,    MT_WU,N,I_X,   N,IM_X,   N,ID_X,   N,FM_X,    N,FD_X,   N,FC_X,    N,FV_X),
    VSSSEGB   ->List(Y,Y,N,R_,RS,RS,R_,IMM_X,FN_ADD, DW_XPR,A1_RS1, A2_ZERO,N,FP_,FX,       Y,MM_S, M_XWR,    MT_B, N,I_X,   N,IM_X,   N,ID_X,   N,FM_X,    N,FD_X,   N,FC_X,    N,FV_X),
    VSSSEGH   ->List(Y,Y,N,R_,RS,RS,R_,IMM_X,FN_ADD, DW_XPR,A1_RS1, A2_ZERO,N,FP_,FX,       Y,MM_S, M_XWR,    MT_H, N,I_X,   N,IM_X,   N,ID_X,   N,FM_X,    N,FD_X,   N,FC_X,    N,FV_X),
    VSSSEGW   ->List(Y,Y,N,R_,RS,RS,R_,IMM_X,FN_ADD, DW_XPR,A1_RS1, A2_ZERO,N,FP_,FX,       Y,MM_S, M_XWR,    MT_W, N,I_X,   N,IM_X,   N,ID_X,   N,FM_X,    N,FD_X,   N,FC_X,    N,FV_X),
    ...
    VLASEGB   ->List(Y,Y,N,RS,RA,R_,R_,IMM_X,FN_ADD, DW_XPR,A1_RS1, A2_ZERO,N,FP_,FX,       Y,MM_S, M_XRD,    MT_B, N,I_X,   N,IM_X,   N,ID_X,   N,FM_X,    N,FD_X,   N,FC_X,    N,FV_X),
    VLASEGH   ->List(Y,Y,N,RS,RA,R_,R_,IMM_X,FN_ADD, DW_XPR,A1_RS1, A2_ZERO,N,FP_,FX,       Y,MM_S, M_XRD,    MT_H, N,I_X,   N,IM_X,   N,ID_X,   N,FM_X,    N,FD_X,   N,FC_X,    N,FV_X),
    VLASEGW   ->List(Y,Y,N,RS,RA,R_,R_,IMM_X,FN_ADD, DW_XPR,A1_RS1, A2_ZERO,N,FP_,FX,       Y,MM_S, M_XRD,    MT_W, N,I_X,   N,IM_X,   N,ID_X,   N,FM_X,    N,FD_X,   N,FC_X,    N,FV_X),
    VLASEGD   ->List(Y,Y,N,RS,RA,R_,R_,IMM_X,FN_ADD, DW_XPR,A1_RS1, A2_ZERO,N,FP_,FX,       Y,MM_S, M_XRD,    MT_D, N,I_X,   N,IM_X,   N,ID_X,   N,FM_X,    N,FD_X,   N,FC_X,    N,FV_X),
    VLASEGBU  ->List(Y,Y,N,RS,RA,R_,R_,IMM_X,FN_ADD, DW_XPR,A1_RS1, A2_ZERO,N,FP_,FX,       Y,MM_S, M_XRD,    MT_BU,N,I_X,   N,IM_X,   N,ID_X,   N,FM_X,    N,FD_X,   N,FC_X,    N,FV_X),
    VLASEGHU  ->List(Y,Y,N,RS,RA,R_,R_,IMM_X,FN_ADD, DW_XPR,A1_RS1, A2_ZERO,N,FP_,FX,       Y,MM_S, M_XRD,    MT_HU,N,I_X,   N,IM_X,   N,ID_X,   N,FM_X,    N,FD_X,   N,FC_X,    N,FV_X),
    VLASEGWU  ->List(Y,Y,N,RS,RA,R_,R_,IMM_X,FN_ADD, DW_XPR,A1_RS1, A2_ZERO,N,FP_,FX,       Y,MM_S, M_XRD,    MT_WU,N,I_X,   N,IM_X,   N,ID_X,   N,FM_X,    N,FD_X,   N,FC_X,    N,FV_X),
    VSASEGB   ->List(Y,Y,N,R_,RA,RS,R_,IMM_X,FN_ADD, DW_XPR,A1_RS1, A2_ZERO,N,FP_,FX,       Y,MM_S, M_XWR,    MT_B, N,I_X,   N,IM_X,   N,ID_X,   N,FM_X,    N,FD_X,   N,FC_X,    N,FV_X),
    VSASEGH   ->List(Y,Y,N,R_,RA,RS,R_,IMM_X,FN_ADD, DW_XPR,A1_RS1, A2_ZERO,N,FP_,FX,       Y,MM_S, M_XWR,    MT_H, N,I_X,   N,IM_X,   N,ID_X,   N,FM_X,    N,FD_X,   N,FC_X,    N,FV_X),
    VSASEGW   ->List(Y,Y,N,R_,RA,RS,R_,IMM_X,FN_ADD, DW_XPR,A1_RS1, A2_ZERO,N,FP_,FX,       Y,MM_S, M_XWR,    MT_W, N,I_X,   N,IM_X,   N,ID_X,   N,FM_X,    N,FD_X,   N,FC_X,    N,FV_X),
    VSASEGD   ->List(Y,Y,N,R_,RA,RS,R_,IMM_X,FN_ADD, DW_XPR,A1_RS1, A2_ZERO,N,FP_,FX,       Y,MM_S, M_XWR,    MT_D, N,I_X,   N,IM_X,   N,ID_X,   N,FM_X,    N,FD_X,   N,FC_X,    N,FV_X),
