...
class vu extends Component
{
  ...
  vxu_cmdq.io.enq_bits <> vcu.io.vxu_cmdq.bits;
  vxu_cmdq.io.enq_val <> vcu.io.vxu_cmdq.valid;
  vxu_cmdq.io.enq_rdy <> vcu.io.vxu_cmdq.ready;
  ...
  vxu_imm2q.io.enq_rdy <> vcu.io.vxu_imm2q.ready;
  // new
  ...
  vxu.io.vxu_cmdq.bits <> vxu_cmdq.io.deq_bits;
  vxu.io.vxu_cmdq.ready <> vxu_cmdq.io.deq_rdy;
  vxu.io.vxu_cmdq.valid <> vxu_cmdq.io.deq_val;
  ...
  vxu.io.vxu_imm2q.ready <> vxu_imm2q.io.deq_rdy;

  vxu.io.vmu_vcmdq.bits <> vmu_vcmdq.io.enq_bits;
  vxu.io.vmu_vcmdq.valid <> vmu_vcmdq.io.enq_val;
  vxu.io.vmu_vcmdq.ready <> vmu_vcmdq.io.enq_rdy;
  
  vxu.io.vmu_vbaseq.bits <> vmu_vbaseq.io.enq_bits;
  vxu.io.vmu_vbaseq.valid <> vmu_vbaseq.io.enq_val;
  vxu.io.vmu_vbaseq.ready <> vmu_vbaseq.io.enq_rdy;

  vxu.io.vmu_vstrideq.bits <> vmu_vstrideq.io.enq_bits;
  ...
  vmu_utcmdq.io.enq_bits <> vxu.io.vmu_utcmdq.bits;
  ...
  val vmu = new vuVMU();
  vmu.io.vmu_vcmdq.bits <> vmu_vcmdq.io.deq_bits;
  vmu.io.vmu_vcmdq.valid <> vmu_vcmdq.io.deq_val;
  vmu.io.vmu_vcmdq.rdy <> vmu_vcmdq.io.deq_rdy;

  vmu.io.vmu_vbaseq.bits <> vmu_vbaseq.io.deq_bits;
  vmu.io.vmu_vbaseq.valid <> vmu_vbaseq.io.deq_val;
  vmu.io.vmu_vbaseq.rdy <> vmu_vbaseq.io.deq_rdy;
  
  vmu.io.vmu_vstrideq.bits <> vmu_vstrideq.io.deq_bits;
  vmu.io.vmu_vstrideq.valid <> vmu_vstrideq.io.deq_val;
  vmu.io.vmu_vstrideq.rdy <> vmu_vstrideq.io.deq_rdy;
  ...
  vmu.io.vmu_utcmdq.bits <> vmu_utcmdq.io.deq_bits;
  vmu.io.vmu_utcmdq.valid <> vmu_utcmdq.io.deq_val;
  vmu.io.vmu_utcmdq.rdy <> vmu_utcmdq.io.deq_rdy;

  vmu.io.vmu_utimmq.bits <> vmu_utimmq.io.deq_bits;
  vmu.io.vmu_utimmq.valid <> vmu_utimmq.io.deq_val;
  vmu.io.vmu_utimmq.rdy <> vmu_utimmq.io.deq_rdy;
